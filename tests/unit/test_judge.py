"""
Tests for JudgeAgent and BaseAgent utilities.

JudgeAgent tests cover: child-agent spawning, full debate execution,
context routing, and verdict constraints.
BaseAgent tests cover: the layered JSON parsing fallback strategy.
"""
